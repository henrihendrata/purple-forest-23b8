...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-forest-23b8
```

A live public deployment of this template is available at [https://purple-forest-23b8.templates.workers.dev](https://purple-forest-23b8.templates.workers.dev)
